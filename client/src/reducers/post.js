...
export default function(state=initialState, action) {
    switch(action.type) {
        ...
        case UPDATE_LIKES:
            return {
                ...state,
               posts: state.posts.map(post => post._id === action.payload.postId ? {...post, likes: action.payload.likes}
                : post), //post remains same, likes are updated to likes in the payload
                loading: false
            }
        case DELETE_POST:
            return {
